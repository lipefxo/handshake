      ...
      <div className="flex-1 overflow-y-auto admin-scroll px-3 pt-3 space-y-1.5">
        ...
        <div className="relative pb-1.5">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2.5 border border-dashed border-gray-200 rounded-xl text-xs font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 transition-colors bg-white"
          >
          ...
          {showPicker && (
            <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-100 rounded-xl shadow-lg shadow-black/10 overflow-hidden z-20">
